        ...
        if mtf_bias in ("BULLISH", "NEUTRAL") and ema9 > ema21:
            ...
            if entered_pocket and recovered and has_rejection_wick:
                ...
                return SignalCandidate(
                    ...
                    technical_score=min(88.0, max(50.0, 50.0 + 15.0)),
                    mtf_score=max(50.0, 75.0 - 10.0),
                    fno_score=65.0,
                    regime_score=75.0 if ctx.regime == "TREND_UP" else 60.0,
                    overall_confidence=round(0.40 * min(88.0, max(50.0, 50.0 + 15.0)) + 0.20 * max(50.0, 65.0) + 0.20 * 65.0 + 0.20 * 75.0, 1),
                    rationale=[
        ...
        # ── BEARISH PULLBACK INTO POCKET (5M Bearish + 1M EMA9 < EMA21) ──
            ...
            if entered_pocket and recovered and has_rejection_wick:
                ...
                return SignalCandidate(
                    ...
                    mtf_score=max(50.0, 75.0 - 10.0),
                    fno_score=65.0,
                    regime_score=75.0 if ctx.regime == "TREND_DOWN" else 60.0,
                    overall_confidence=round(0.40 * min(88.0, max(50.0, 50.0 + 15.0)) + 0.20 * max(50.0, 65.0) + 0.20 * 65.0 + 0.20 * 75.0, 1),
                    rationale=[
