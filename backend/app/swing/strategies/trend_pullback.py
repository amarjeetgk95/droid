...
class PullbackOptionsStrategy(BaseSwingStrategy):
    ...
    def evaluate(
        ...
        strategy_id = "PULLBACK_CE" if is_bullish else "PULLBACK_PE"
        ...
        # Build chain quotes if chain provided
        ...
        dte = max(1, (contract.expiry_date - __import__("datetime").date.today()).days) if contract.expiry_date else 8
