...
def analyze_multi_timeframe(analyses: dict, fno_available: bool = False) -> dict:
    ...
    combined_conf = round(mtf_score,1)
    ...
    for tf in ["1m","5m","15m","1h","4h","1D"]:
        if tf in analyses:
            ...
            per_tf[tf]={"bias": analyses[tf].get("bias","NEUTRAL"), "score": analyses[tf].get("score",50), "data_unavailable": False}
