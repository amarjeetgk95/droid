...
export default function DeepInsightRedirectPage() {
  const router = useRouter();

  useEffect(() => {
    router.replace('/ai-command-center?tab=signal');
  }, [router]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] gap-3 text-center p-6">
      ...
      <p className="text-xs text-muted-foreground max-w-sm">
        AI Live Calls and AI Research have been unified into a single AI Command Center.
      </p>
      <Link
        href="/ai-command-center?tab=signal"
