  ...
  return (
    <div className="bg-card border border-border rounded-xl p-4 space-y-4 shadow-xs">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        ...
        <div className="bg-secondary/40 border border-border rounded-xl p-2.5 space-y-0.5">
          <span className="text-[10px] text-muted-foreground font-semibold">Total Account Value</span>
        ...
        {/* Unrealized MTM */}
        <div className="bg-secondary/40 border border-border rounded-xl p-2.5 space-y-0.5">
          <span className="text-[10px] text-muted-foreground font-semibold flex items-center justify-between">
            Open MTM
            {isMtmPos ? <TrendingUp className="w-3 h-3 text-emerald-400" /> : <TrendingDown className="w-3 h-3 text-rose-400" />}
          </span>
          ...
          <span className="text-[9px] text-muted-foreground font-mono">
            <strong>{summary.open_positions_count} open</strong>
          </span>
        </div>
